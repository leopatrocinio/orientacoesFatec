...
class AlunosController extends AppController
{
    ...
    public function view($id = null)
    {
        $aluno = $this->Alunos->get($id, [
            'contain' => ['Cursos', 'Orientadores', 'Trabalhos'],
        ]);
    ...
    public function add()
    {
        ...
        $orientadores = $this->Alunos->Orientadores->find('list', ['limit' => 200]);
        $this->set(compact('aluno', 'cursos', 'orientadores'));
    }
